<x-layout>
    ...
    <x-card class="space-y-8">
        ...
        <div>
            ...
            <form action="{{route('auth.verify.create.token')}}" method="post">
                @csrf
                <button type="submit" class="cursor-pointer border rounded-md px-2 py-2 text-sm border-red-400 bg-red-100 text-red-400 hover:bg-red-200 hover:text-red-500 hover:border-red-500" >Verify Your Email</button>
            </form>
